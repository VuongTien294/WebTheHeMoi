...
export default class CardAddUser extends React.Component {
    ...
    addUser = async () => {
        if (this.state.username.length >= 6 && this.state.password.length >= 6) {
            ...
            alert("Username or Password are less than seven characters!")
        }
                        ...
                        <div className="flex flex-wrap">
                            <div className="w-full lg:w-12/12 px-4">
                                <div className="relative w-full mb-3">
                                    ...
                                    <select className="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" name="role" onChange={this.setParam}>
                                        <option value="">---***---</option>
